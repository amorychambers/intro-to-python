...
my_subtracted = 2 - 3
print(f"2 - 3 = {my_subtracted} (should be -1)")

#Division

my_divided = 2 / 3
print(f"2 / 3 = {round(my_divided, 2)} (should be 0.67)")

# Modulus

modulated = 2 % 3 # modulated? that can't be right
print(f"2 % 3 = {modulated} (should be 2)")

# Exponentiation

exponentiated = 2 ** 3
print(f"2 ** 3 = {exponentiated} (should be 8)")

# Floor division

utterly_floored = 2 // 3
print(f"2 // 3 = {utterly_floored} (should be 0)")
